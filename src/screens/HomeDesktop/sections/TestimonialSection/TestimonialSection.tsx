...
const testimonialData = {
  ...
  author: {
    ...
    avatar: "https://c.animaapp.com/ZszZBpsA/img/avatar-image@2x.png",
  },
};

export const TestimonialSection = (): JSX.Element => {
  return (
    <section className="flex flex-col items-center gap-20 pt-[var(--spacing-sizing-section-padding-padding-section-large)] pr-[var(--spacing-sizing-page-padding-padding-global)] pb-[var(--spacing-sizing-section-padding-padding-section-large)] pl-[var(--spacing-sizing-page-padding-padding-global)] relative self-stretch w-full flex-[0_0_auto] bg-[color:var(--color-schemes-color-scheme-3-background)]">
        ...
        <div className="flex flex-col max-w-[var(--spacing-sizing-max-width-max-width-large)] items-center gap-8 relative w-full flex-[0_0_auto]">
          ...
          <div className="flex flex-col w-[300px] items-center gap-4 relative flex-[0_0_auto]">
            <img
              ...
              alt={`Avatar of ${testimonialData.author.name}`}
              src={testimonialData.author.avatar}
            />

            <div className="flex flex-col items-start relative self-stretch w-full flex-[0_0_auto]">
              <div className="relative self-stretch mt-[-1.00px] font-text-regular-semi-bold font-[number:var(--text-regular-semi-bold-font-weight)] text-color-schemes-color-scheme-3-text text-[length:var(--text-regular-semi-bold-font-size)] text-center tracking-[var(--text-regular-semi-bold-letter-spacing)] leading-[var(--text-regular-semi-bold-line-height)] [font-style:var(--text-regular-semi-bold-font-style)]">
